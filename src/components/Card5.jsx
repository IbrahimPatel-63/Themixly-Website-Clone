...
function Card5({img,title,name,desc,btn1,btn2}) {
  return (
    <div className='h-130 w-[90vw] md:w-[45vw] lg:w-[30vw] 2xl:w-[25vw] bg-[#1e1c1cbc] rounded-2xl overflow-hidden mt-12 border-[.5px] border-[#ffffff32] shrink-0' >
        <div className='h-[62%] w-full bg-teal-400  overflow-hidden relative'>
            <div className='h-full w-full bg-[#0000005c] absolute opacity-0 hover:opacity-[1] transition duration-700 linear'>
